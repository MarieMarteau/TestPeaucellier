	...
	if( pickingData.enableDragAndDrop===true) {
       ...
       selectedPoint.unproject( camera );
		...
		if (pickingData.selectedObject==P){
			...
			leaveDotBleu(sceneGraph,coordP(theta,a,b,c)[0],coordP(theta,a,b,c)[1],coordP(theta,a,b,c)[2]);
			leaveDot(sceneGraph,coordM(theta,a,b,c)[0],coordM(theta,a,b,c)[1],coordM(theta,a,b,c)[2]);
